...
> **This is the single source of truth for all AI coding assistants.**
> `CLAUDE.md`, `GEMINI.md`, `.cursorrules`, `.windsurfrules`, and
> `.github/copilot-instructions.md` are symlinks to this file — edit `AGENTS.md`
> and every assistant picks up the change. Don't fork the content into the
> individual files.
